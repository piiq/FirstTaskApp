Contributing to FirstTask
===============================

There are many ways to contribute to FirstTask.

  * Submit a feature request or bug, or add to the discussion on the [FirstTask issue tracker][is]
  * Submit a [Pull Request][pr] to improve FirstTask.
...
If you are new to FirstTask development and you don't have push access to the FirstTask
...
When submitting a PR, make sure to add a `Cc: @FirstTaskApp/developers` comment to
notify FirstTask developers of your awesome contributions. Based on the
...
* You do NOT have push access: A FirstTask core developer will integrate your PR.
...
[pr]: https://github.com/FirstTaskOrthopedics/FirstTaskApp/merge_requests
[is]: https://github.com/FirstTaskOrthopedics/FirstTaskApp/issues
